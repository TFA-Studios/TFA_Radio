...
export const HELP_LAST_UPDATED = '23 september 2026';
...
export const HELP_SECTIONS = [
  ...
  },
  {
    ...
    blocks: [
      { type: 'ul', items: [
        ...
        'Om te voorkomen dat willekeurig iedereen met de website-link zomaar een brief kan starten, zit er een **toegangscode** op de "Start je commercial"-knop: alleen een link met de juiste code (`/start?code=...`) maakt direct een nieuwe brief aan; zonder (geldige) code krijg je een klein invulveld voor de code te zien. Er is een algemene, terugval-code die je zelf instelt via de `TFA_ACCESS_CODE`-instelling in Vercel.',
        'Daarnaast kun je onder **Agentschappen** (linkermenu) per samenwerkende agency (bijv. Advision Media) een eigen code aanmaken, met een naam en contact-e-mailadres. Een link met zo\'n agency-code doet twee dingen tegelijk: hij laat de klant erdoor, én hij koppelt de nieuwe brief blijvend aan die agency. Overal waar het dashboard of de klant vroeger altijd "Advision Media" noemde (de statuspagina, de bevestigingsmail, de "Uitlevering"-tab), staat nu de naam van de agency die bij die specifieke brief hoort — een brief zonder herkende code blijft "Advision Media" tonen, zoals voorheen. Zo kun je ook zien (via de "Agency"-kolom in de hoofdtabel) welke agency een brief heeft aangebracht.',
      ] },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'ul', items: [
        '**23 sep 2026** — Agentschappen toegevoegd: per samenwerkende agency (bijv. Advision Media) een eigen toegangscode, beheerd via het nieuwe "Agentschappen"-scherm. Een brief die via zo\'n code binnenkomt, wordt er blijvend aan gekoppeld — overal waar voorheen altijd "Advision Media" stond (statuspagina, bevestigingsmail, Uitlevering-tab) staat nu de juiste agency; nieuwe "Agency"-kolom in de hoofdtabel.',
