...
export const HELP_SECTIONS = [
  {
    ...
    blocks: [
      { type: 'p', text: 'SpotFlow is de tool die het hele traject van een radiocommercial regelt: vanaf het moment dat een klant op "Start je commercial" klikt, tot het moment dat de spot goedgekeurd en geleverd is. Er zijn twee kanten aan de app:' },
      { type: 'ul', items: [
